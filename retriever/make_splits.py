...
if __name__ == "__main__":
    num_folds = 5
    src_csv_file = "data/user_data.csv"
    ...
    with open(src_csv_file, "r") as src_f:
        ...
        for row in reader:                        
            questions[row["user_question"]] = {
                ...
                "response": row["support_response"], 
                "classifier_class": row["level_2_classifier"],
                "is_kowledge_base": False 
            }
            questions[row["knowledge_base_question"]] = {
                "question": row["knowledge_base_question"],
                "response": row["knowledge_base_response"], 
                "classifier_class": row["level_2_classifier"],
                "is_kowledge_base": True 
            }
    ...
    for data in examples:
        stratified_labels.append(data["classifier_class"])
